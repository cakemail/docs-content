...
Vous avez maintenant complété votre automation ! Des statistiques seront recueillies pour chaque email dans votre flux, que vous pourrez utiliser pour l'optimiser. Visitez notre article sur l'automation pour un aperçu complet de l'outil.
</Stepper>
...
- Accordez suffisamment de temps pour l'engagement du email avant le branchement
...
- [Comprendre l'automation de email](/fr/docs/automations/understanding-email-automation) - Fondamentaux de l'automation
- [Créer une automation en boucle](/fr/docs/automations/creating-a-looping-automation) - Flux de travail répétitifs
- [Créer un segment](/fr/docs/audience/creating-dynamic-segments) - Brancher par segments
- [Ajouter des attributs à votre liste](/fr/docs/audience/adding-attributes-to-your-list) - Brancher par attributs
- [Déterminer le parcours client](/fr/docs/automations/tracking-customer-journeys-with-custom-attributes) - Suivre les chemins de branchement