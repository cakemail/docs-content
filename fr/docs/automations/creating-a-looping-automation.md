...
1. Pour cet exemple, nous créerons une action de email en boucle. Choisissez l'option **Envoyer un email** dans l'onglet Sélectionner une action
![53E04532-3F6B-4402-AD64-BE15CE5DB172_4_5005_c.jpeg](/images/automations/017E6AE4-F6F3-4E94-B79D-822E7C609FAE.png)

1. Modifiez le email à votre goût.

1. Cliquez sur le signe **+** pour créer une nouvelle étape après l'action Envoyer un email dans le flux d'automation
...
1. Cliquez sur **Sélectionner un type d'événement** et choisissez **Envoyer un email**
...
Vous pouvez faire boucler le email continuellement ou un nombre spécifique de fois
...
**Les emails s'envoient trop fréquemment**
...
- [Créer une automation avec des conditions de branchement](/fr/docs/automations/creating-an-automation-with-branching-conditions) - Logique d'automation avancée
- [Créer un email de bienvenue automatisé](/fr/docs/automations/creating-an-automated-welcome-email) - Exemple d'automation simple
- [Déterminer le parcours client](/fr/docs/automations/tracking-customer-journeys-with-custom-attributes) - Suivre les progrès de l'automation
- [Créer un segment](/fr/docs/audience/creating-dynamic-segments) - Cibler les destinataires d'automation