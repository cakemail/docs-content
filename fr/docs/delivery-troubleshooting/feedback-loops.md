...
Une boucle de rétroaction est un flux de données établi par les fournisseurs de services Internet (FAI) qui transmet les plaintes provenant de leurs utilisateurs à l'expéditeur du message original. Ces données de plainte sont ensuite traitées par l'expéditeur afin qu'il puisse retirer et/ou désabonner définitivement l'utilisateur de la ou des listes en question. Cela aide à éviter les plaintes futures, qui peuvent sérieusement affecter la livraison.

## Pourquoi c'est important

Les boucles de rétroaction donnent aux ESP (fournisseurs de services de email) la capacité de suivre combien de plaintes sont reçues pour un client donné (ou une campagne) afin qu'ils puissent prendre l'action appropriée.
...
- **Gardez les taux de plainte sous 0,25 %** (1 sur 400 emails)
...
- **Utilisez le double abonnement** pour assurer que les abonnés veulent vos emails

## Impact sur la délivrabilité

Des taux élevés de plainte peuvent résulter en :
- **Emails bloqués** au niveau des FAI
...
- Rendez les liens de désabonnement proéminents et faciles à utiliser
...
- [Comprendre les plaintes, rebonds et désabonnements](/fr/docs/analytics/email-bounces) - Gestion des plaintes
- [Mise sur liste noire de mon domaine](/fr/docs/delivery-troubleshooting/domain-blacklisting) - FBL prévient la mise sur liste noire
- [Maîtriser les bases de la délivrabilité](/fr/docs/delivery-troubleshooting/email-deliverability) - Importance des FBL
- [Utiliser la liste de suppression](/fr/docs/account-settings/suppression-lists) - Suppressions FBL
- [Inclure un lien de désabonnement](/fr/docs/campaign-creation/adding-unsubscribe-links) - Réduire les plaintes