...
# Hygiène des listes : maintenir une base de données d'emails saine

## Le Défi

Votre liste d'emails se dégrade naturellement d'environ 22,5 % chaque année. Les gens changent d'emploi, abandonnent leurs adresses email ou perdent leur intérêt pour votre contenu. Sans maintenance régulière, vous ne gaspillez pas seulement de l'argent en envoyant à des adresses invalides, mais vous endommagez également votre réputation d'expéditeur et réduisez l'efficacité globale de vos campagnes.

## L'Impact

Une mauvaise gestion des listes entraîne :
...
### 1. Programme régulier de nettoyage des listes

**Tâches mensuelles :**
- Examiner les rapports de rebonds et supprimer immédiatement les rebonds définitifs
- Vérifier les adresses email basées sur des rôles (info@, admin@, sales@) et envisager de les supprimer
...
- Valider les adresses email à l'aide d'outils de vérification
- Vérifier les pièges à spam et les honeypots
...
**Types à supprimer :**
- **Hard bounces** : Adresses email invalides ou inexistantes
...
- **Signaleurs de spam**: Toute personne vous ayant signalé comme spam

**Signaux d'alerte à surveiller :**
- Modèles d'email génériques (test@, asdf@, 123@)
...
**Étape 2** : Créer un email de réengagement convaincant
- Objet : "Vous nous manquez ! Voici 20 % de réduction pour votre retour"
- Proposition de valeur claire
- Option de désabonnement facile

**Étape 3** : Envoyez 2-3 emails sur 2 semaines
**Étape 4** : Retirer les non-répondants après la dernière tentative

### 4. Mettre en œuvre des mesures préventives

**À l'inscription :**
- Utiliser la double authentification pour vérifier les adresses email
- Mettre en place un CAPTCHA pour empêcher les soumissions automatisées
- Ajouter la validation des emails aux formulaires (vérification de la syntaxe)
- Définir les attentes concernant la fréquence des emails
...
- Faciliter le désabonnement pour éviter les plaintes de spam

### 5. Utiliser les listes de suppression

Maintenir une liste de suppression principale contenant :
- Tous les désabonnements sur toutes les listes
- Bounces définitifs
- Plaignants spam
...
- **Réduction des coûts** : Coûts de service email réduits de 20-30 %
- **Engagement plus élevé** : Augmentation de 40-50 % des taux d'ouverture
- **Meilleur retour sur investissement** : Augmentation de 25 % des revenus par email
...
5. **Acheter ou louer des listes** : N'ajoutez jamais de contacts achetés
...
- [Construire une liste d'emails de qualité : meilleures pratiques](/fr/best-practices/list-building/building-a-quality-email-list-best-practices)
