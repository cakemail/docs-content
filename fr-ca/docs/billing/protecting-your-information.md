...
- Effacez les témoins et le cache du navigateur
...
- Ne partagez jamais les détails de paiement par courriel ou canaux non sécurisés
...
- [Gestion de votre facturation](/fr-ca/docs/billing/update-your-billing-information) - Gestion sécurisée de la facturation
- [Configuration de l'authentification multifacteurs (AMF)](/fr-ca/docs/account-settings/multi-factor-authentication-mfa) - Sécurité du compte
- [Demande de suppression de compte](/fr-ca/docs/account-settings/canceling-your-account) - Suppression des données
- [Ajouter et modifier des utilisateurs](/fr-ca/docs/account-settings/adding-and-editing-users) - Contrôle d'accès
- [Premiers pas](/fr-ca/docs/first-steps) - Bases de la sécurité