...
L'action par défaut sur une automation sera d'envoyer un courriel automatisé. Vous pouvez modifier le courriel avec le concepteur de courriel et déterminer la ligne d'objet du courriel dans le menu des paramètres de déploiement.

![Panneau de configuration d'action de courriel](/images/automations/E97A2994-721A-4A9A-9B0A-4E8F0D52D6D0_4_5005_c.jpeg)
...
Cliquez sur le courriel pour voir un panneau latéral plus détaillé. Vous pouvez voir les taux d'ouverture, de clic, de désabonnement, de livraison et de rebond pour votre courriel.

![Panneau détaillé des métriques de performance de courriel](/images/automations/Capture_d_e_cran__le_2022-04-25_a__14.58.34.png)
...
- Vérifiez que la période sélectionnée correspond au moment où les courriels ont été envoyés
- Vérifiez que les pixels de suivi ne sont pas bloqués par les clients de courriel

**Problèmes avec le concepteur de courriel**
...
- Assurez-vous que tous les blocs de contenu de courriel sont complétés
...
- [Créer un courriel de bienvenue automatisé](/fr-ca/docs/automations/creating-an-automated-welcome-email) - Votre première automation
- [Créer une automation avec des conditions de branchement](/fr-ca/docs/automations/creating-an-automation-with-branching-conditions) - Flux de travail avancés
- [Créer une automation en boucle](/fr-ca/docs/automations/creating-a-looping-automation) - Campagnes récurrentes
- [Premiers pas](/fr-ca/docs/first-steps) - Guide de démarrage
- [Créer et gérer une liste de contacts](/fr-ca/docs/audience/managing-contact-lists) - Destinataires d'automation