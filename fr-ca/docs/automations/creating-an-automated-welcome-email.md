...
1. Sélectionnez l'action **Envoyer un courriel** dans l'affichage du flux de travail

1. Cliquez sur **Modifier** pour personnaliser le courriel
...
1. Utilisez le concepteur de courriel pour personnaliser votre courriel de confirmation. Trouvez une description de cet outil ici.

1. Lorsque vous avez terminé de modifier le courriel, cliquez sur **Enregistrer et quitter**
...
Un courriel avec votre message de bienvenue personnalisé sera envoyé automatiquement à votre nouveau destinataire chaque fois qu'il s'abonne à votre contenu après le délai déterminé.
</Stepper>

## Dépannage

**Le courriel de bienvenue ne s'envoie pas**
...
**Le courriel va dans les pourriels**

- Incluez des instructions d'authentification dans votre courriel de bienvenue
- Demandez aux abonnés d'ajouter votre adresse d'expéditeur à leurs contacts
- Évitez les mots déclencheurs de pourriel dans les lignes d'objet et le contenu

**Problèmes de délai**

- Vérifiez les paramètres de délai dans le flux de travail de l'automation
- Définissez le délai à « immédiatement » pour les courriels de bienvenue instantanés
...
- [Configurer un courriel de confirmation d'abonnement](/fr-ca/docs/audience-building/subscription-confirmation-email) - Confirmation pré-bienvenue
- [Créer une automation en boucle](/fr-ca/docs/automations/creating-a-looping-automation) - Automation avancée
