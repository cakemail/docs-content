...
**Les solutions de repli fonctionnent en aperçu mais pas dans les courriels envoyés**
...
- [Ajouter des balises de fusion à une campagne](/fr-ca/docs/personalization/adding-merge-tags-to-a-campaign) - Guide d'implémentation
- [Ajouter des attributs à votre liste](/fr-ca/docs/audience/adding-attributes-to-your-list) - Créer des champs de fusion
- [Ajouter votre adresse physique](/fr-ca/docs/campaign-creation/adding-your-physical-address) - Balise de fusion d'adresse
- [Importer des contacts](/fr-ca/docs/audience/importing-contacts-into-your-lists) - Importer des données de fusion
