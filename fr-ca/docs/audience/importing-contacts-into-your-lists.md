...
Nous ne voulons pas exagérer, mais cela ne peut être assez souligné ; vos destinataires doivent s'être abonnés à votre liste en ligne et avoir choisi de recevoir un ou plusieurs types de courriels. Avec tout en ordre, il est maintenant temps de commencer à envoyer des courriels à vos contacts !
...
- **Qualité des données** : Assurez-vous que votre fichier CSV est correctement formaté avec des adresses courriel correctes
...
- Vérifiez que les adresses courriel sont correctement formatées
...
- Vérifiez si les courriels existent déjà comme désabonnés
...
- Les adresses courriel sont sensibles à la casse
- Vérifiez les espaces en fin dans la colonne courriel
...
- [Créer et gérer une liste de contacts](/fr-ca/docs/audience/managing-contact-lists) - Créer des listes pour les importations
- [Ajouter des attributs à votre liste](/fr-ca/docs/audience/adding-attributes-to-your-list) - Importer des champs personnalisés
- [Créer et utiliser des étiquettes](/fr-ca/docs/audience/using-tags-to-track-engagement) - Étiqueter les contacts importés
- [Configurer un courriel de confirmation d'abonnement](/fr-ca/docs/audience-building/subscription-confirmation-email) - Confirmer les contacts importés  
