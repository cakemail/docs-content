...
Vous pouvez le faire soit dans le concepteur de courriel ou l'éditeur HTML. Deux options sont disponibles :

### Ajouter votre lien de désinscription avec le concepteur de courriel
Quand le système ne reconnaît pas le champ de fusion du lien de désinscription dans la campagne, il l'ajoutera automatiquement au bas. Il est préférable de surligner et d'ajouter `[UNSUBSCRIBE]` comme un hyperlien pour éviter cela.
...
1. Sélectionnez votre texte de désinscription.
...
1. Liez votre champ de désinscription à l'URL [UNSUBSCRIBE]
...
Sur la petite barre d'outils de texte, sélectionnez Liens spéciaux > Abonnement > Désinscription
</Stepper>

### Ajouter votre lien de désinscription dans l'éditeur HTML 

En sélectionnant l'option commencer à partir de zéro, vous pouvez créer votre gabarit à partir de votre propre code HTML. Pour ajouter correctement le champ de désinscription avec cette option, suivez ces étapes :
...
1. Surlignez le champ Désinscription.
![Bouton Cliquer modifier le courriel](/images/campaign-creation/0982228B-E876-422A-97FE-32ABEB639811_4_5005_c.jpeg)

1. Liez votre champ de désinscription à l'URL [UNSUBSCRIBE] en utilisant l'option de lien dans le menu d'édition.
...
Vous éviterez le désagrément de voir votre contenu marqué comme pourriel si votre destinataire décide d'arrêter de recevoir votre contenu. Comme toujours, notre équipe de support sera plus qu'heureuse de suggérer des façons d'améliorer vos pratiques et votre contenu si vous en avez besoin.
...
**La campagne ne s'enverra pas sans désinscription**

- Le système exige un lien de désinscription pour la conformité
- Vérifiez le pied de page pour un lien de désinscription ajouté automatiquement
- Ajoutez manuellement la balise [UNSUBSCRIBE] si elle manque

**Lien ajouté deux fois**

- Supprimez le lien de désinscription manuel si le système en ajoute un automatiquement
- Vérifiez à la fois le pré-en-tête et le pied de page pour les liens dupliqués
- Utilisez le mode aperçu pour vérifier une seule instance

**Problèmes de formatage**

- Gardez le lien de désinscription visible et facile à trouver
...
- [Ajouter votre adresse physique](/fr-ca/docs/campaign-creation/adding-your-physical-address) - Exigences légales
- [Utiliser la liste de suppression](/fr-ca/docs/account-settings/suppression-lists) - Gérer les désinscriptions
- [Comprendre les plaintes, rebonds et désinscriptions](/fr-ca/docs/analytics/email-bounces) - Métriques de désinscription
- [Configurer votre centre de préférences d'abonné](/fr-ca/docs/audience-building/subscriber-preference-center) - Préférences avancées
- [Créer des campagnes](/fr-ca/docs/campaign-creation/creating-campaigns) - Conformité des campagnes