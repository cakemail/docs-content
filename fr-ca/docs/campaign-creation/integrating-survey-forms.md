...
## Description
Les sondages intégrés dans les courriels, aussi appelés sondages en ligne de courriel, sont intégrés dans les courriels, et les répondants peuvent répondre aux questions directement dans le corps du courriel. Les sondages de cette nature tendent à être courts et non exhaustifs.
...
Utilisez l'outil en ligne gratuit https://www.typeform.com/ pour créer un sondage. Ensuite, vous pouvez copier et coller le code courriel du sondage (code HTML).
...
- Testez dans plusieurs clients de courriel pour la compatibilité
...
- Vérifiez que JavaScript n'est pas inclus (les clients de courriel le bloquent)

**Faibles taux de réponse**

- Gardez les sondages courts (1-3 questions maximum)
- Placez le sondage de manière proéminente dans le courriel
...
- Certains clients de courriel peuvent ne pas supporter les formulaires intégrés
- Fournissez un lien de remplacement vers la version web
- Testez à travers les clients de courriel principaux avant d'envoyer

## Articles connexes

- [Créer des campagnes](/fr-ca/docs/campaign-creation/creating-campaigns) - Configuration de base de campagne
- [Ajouter des liens d'ancrage](/fr-ca/docs/campaign-creation/adding-anchor-links-to-the-email-content-with-html) - Lien vers les sondages
- [Suivre l'activité du taux de clics](/fr-ca/docs/analytics/tracking-click-rate-activity) - Suivre les clics de sondage
- [Utiliser le concepteur de courriel](/fr-ca/docs/campaign-creation/using-the-email-designer) - Ajouter des boutons de sondage
- [Créer des liens de suivi UTM](/fr-ca/docs/campaign-creation/create-utm-tracking-links) - Suivre les réponses de sondage