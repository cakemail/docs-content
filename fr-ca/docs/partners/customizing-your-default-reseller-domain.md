...
Mais si votre domaine revendeur est déjà authentifié, les courriels seront envoyés avec ce domaine. Nous vous encourageons fortement à authentifier votre domaine. Cela vous permettra d'offrir un domaine d'envoi plus personnalisé à vos clients qui n'ont pas encore authentifié.
...
Cliquez sur Authentifier le domaine à droite pour afficher les codes à copier et coller sur votre serveur. Vous pouvez aussi cliquer pour télécharger les instructions et les envoyer par courriel à votre administrateur.
...
- [Configurer et personnaliser les courriels système](/fr-ca/docs/partners/system-email-customization) - Courriels système de marque
- [Gérer les couleurs de votre marque](/fr-ca/docs/account-settings/configuring-your-brand) - Image de marque complète
- [Partager des gabarits de courriel](/fr-ca/docs/partners/client-template-sharing) - Gabarits de marque
- [Authentifier mon domaine](/fr-ca/docs/senders/authenticating-domains) - Configuration de domaine
- [Mettre à jour mon profil d'entreprise](/fr-ca/docs/account-settings/updating-my-company-profile) - Profil partenaire